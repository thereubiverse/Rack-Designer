...
export const detectPortsAction = withEditor("ai.detectPorts", async (
  member, input: { imageBase64: string; mimeType: string; modelHint?: string },
...
export const identifyDeviceAction = withEditor("ai.identifyDevice", async (member, modelName: string): Promise<DetectResult> => {
